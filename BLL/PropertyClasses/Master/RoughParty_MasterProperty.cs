...
{
    public class RoughParty_MasterProperty
    {
        public int rough_party_id { get; set; }
        public string rough_party_shortname { get; set; }
        public string rough_party_name { get; set; }
