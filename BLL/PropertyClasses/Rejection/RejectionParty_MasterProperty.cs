...
{
    public class RejectionParty_MasterProperty
    {
        public int rejection_party_id { get; set; }
        public string rejection_party_shortname { get; set; }
        public string rejection_party_name { get; set; }
