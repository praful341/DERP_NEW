...
namespace BLL.FunctionClasses.Report
{
    public class NewReportMaster
    {
        ...
        public int FindNewID()
        {
            ...
            //else
            //{
            //    return Ope.FindNewID(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, BLL.TPV.Table.MST_Report, "MAX(report_code)", "");
            //}
        }
        public void GetReportDetail(int pIntReportCode)
        {
            ...
            //else
            //{
            //    Ope.GetDataSet(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, DS, TableNameDetail, Request);
            //}
        }
        int i = 0;
        public void GetReportSettings(int pIntReportCode, string pStrReportType, int pStruserId)
        {
            if (i == 0)
            {
                ...
                //else
                //{
                //    Ope.GetDataSet(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, DS, TableNameSettings, Request);
                //}
                i = i + 1;
            }
            else
        ...
        public DataTable GetReportSettings_For_Template(int pIntReportCode, string pStrReportType)
        {
            ...
            //else
            //{
            //    Ope.GetDataTable(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, DtResult, Request);
            //}
            return DtResult;
        }
        ...
        public New_Report_MasterProperty GetReportMasterProperty_ForTemplate(int pIntReportCode, string pStrReportGroup = null)
        {
            ...
            //else
            //{
            //    DRow = Ope.GetDataRow(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, Request);
            //}
            //DataRow DRow = Ope.GetDataRow(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, Request);
