...
{
    public class MstBillManagerMaster
    {
        ...
        public int SaveBillManager(MstBillManagerMasterProperty pClsProperty)
        {
            int IntRes = 0;
            ...
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.MST_BILL_Manager_Save;
        ...
        {
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MST_BILL_Manager_GetData;
            Request.CommandType = CommandType.StoredProcedure;
            if (GlobalDec.gEmployeeProperty.Allow_Developer == 0)
            {
