...
namespace BLL.FunctionClasses.Master
{
    public class CountryMaster
    {
        ...
        public string ISExists(string CountryName, Int64 CountryId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Country", "country_name", "AND country_name = '" + CountryName + "' AND NOT country_id =" + CountryId));
            }
        }
    }
}
