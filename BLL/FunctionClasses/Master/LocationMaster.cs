...
namespace BLL.FunctionClasses.Master
{
    public class LocationMaster
    {
        ...
        public DataTable GetLocationWiseCompanyBranch()
        {
            ...
            Request.CommandText = BLL.TPV.SProc.MST_LocationWiseCompanyBranch;
            Request.CommandType = CommandType.StoredProcedure;
            if (GlobalDec.gEmployeeProperty.Allow_Developer == 0)
            {
                Ope.GetDataTable(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, DTab, Request);
        ...
        public string ISExists(string LocName, Int64 LocId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Location", "location_name", "AND location_name = '" + LocName + "' AND NOT location_id =" + LocId));
            }
        }
    }
}
