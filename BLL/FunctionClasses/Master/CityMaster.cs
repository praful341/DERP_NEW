...
namespace BLL.FunctionClasses.Master
{
    public class CityMaster
    {
        ...
        public string ISExists(string CityName, Int64 CityId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_City", "city_name", "AND city_name = '" + CityName + "' AND NOT city_id =" + CityId));
            }
        }
    }
}
