...
namespace BLL.FunctionClasses.Master
{
    public class PartyMaster
    {
        ...
        public DataTable Save_A(Party_MasterProperty pClsProperty, Int64 Party_Id)
        {
            ...
            try
            {
                ...
                Request.AddParams("@party_city_name", pClsProperty.party_city_name, DbType.String);
                Request.AddParams("@party_full_name", pClsProperty.party_full_name, DbType.String);
                ...
                Request.AddParams("@party_mobile_no", pClsProperty.party_mobile_no, DbType.String);
        ...
        public DataTable Save_B(Party_MasterProperty pClsProperty, Int64 Party_Id)
        {
            DataTable p_dtbPartyId = new DataTable();
            try
            {
        ...
        public int Update_A(Party_MasterProperty pClsProperty)
        {
        ...
        public int Update_B(Party_MasterProperty pClsProperty)
        {
            Request RequestDetails = new Request();
            int IntRes = 0;
        ...
        public string ISExists(string Party, Int64 PartyId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Party", "party_name", "AND party_name = '" + Party + "' AND NOT party_id =" + PartyId));
            }
        }
        public Int64 FindPartyID(string PartyName)
        {
            ...
            {
                IntPartyID = Ope.FindSrNo(DBConnections.ConnectionDeveloper, DBConnections.ProviderDeveloper, "MST_Party", "party_id", " AND party_name = '" + PartyName + "'");
            }
            return IntPartyID;
        }
        public DataSet Get_PartyName_Print(Int64 p_numPartyID)
        {
            DataSet DTab = new DataSet();
            try
            {
                Request Request = new Request();
                Request.CommandText = BLL.TPV.SProc.RPT_MST_Party_Name_GetData;
                Request.CommandType = CommandType.StoredProcedure;

                Request.AddParams("@p_numPartyID", p_numPartyID, DbType.Int64);
