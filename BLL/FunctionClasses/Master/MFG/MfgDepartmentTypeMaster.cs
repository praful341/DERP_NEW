...
namespace BLL.FunctionClasses.Master.MFG
{
    public class MfgDepartmentTypeMaster
    {
        ...
        public string ISExists(string DeptType, Int64 DeptTypeId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MFG_MST_Department_Type", "department_type", "AND department_type = '" + DeptType + "' AND NOT department_type_id =" + DeptTypeId));
            }
        }
    }
}
