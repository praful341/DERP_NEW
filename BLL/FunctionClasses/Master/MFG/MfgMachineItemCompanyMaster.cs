...
{
    public class MfgMachineItemCompanyMaster
    {
        InterfaceLayer Ope = new InterfaceLayer();
        Validation Val = new Validation();
        public int Save(MfgMachineCompany_MasterProperty pClsProperty)
        {
            ...
            Request.CommandText = BLL.TPV.SProc.MFG_MST_MachineCompany_Save;
        ...
        public DataTable GetData(int active = 0)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_MST_MachineCompany_GetData;
            Request.CommandType = CommandType.StoredProcedure;
