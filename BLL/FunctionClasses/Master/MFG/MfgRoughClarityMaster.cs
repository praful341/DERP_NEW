...
{
    public class MfgRoughClarityMaster
    {
        InterfaceLayer Ope = new InterfaceLayer();
        Validation Val = new Validation();
        public int Save(MfgRoughClarity_MasterProperty pClsProperty)
        {
            Request Request = new Request();

            Request.AddParams("@rough_clarity_id", pClsProperty.rough_clarity_id, DbType.Int32);
            Request.AddParams("@rough_clarity_name", pClsProperty.rough_clarity_name, DbType.String);
            ...
            Request.CommandText = BLL.TPV.SProc.MFG_MST_Rough_Clarity_Save;
        ...
        public DataTable GetData(int active = 0)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_MST_Rough_Clarity_GetData;
            Request.CommandType = CommandType.StoredProcedure;
