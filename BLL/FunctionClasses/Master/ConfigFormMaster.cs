...
namespace BLL.FunctionClasses.Master
{
    public class ConfigFormMaster
    {
        ...
        public string ISExists(string ConfigFormName, Int64 FormId)
        {
            ...
            //else
            //{
            //    return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "Config_Form", "form_name", "AND form_name = '" + ConfigFormName + "' AND NOT form_id =" + FormId));
            //}
        }
    }
}
