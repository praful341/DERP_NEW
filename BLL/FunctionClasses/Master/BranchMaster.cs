...
namespace BLL.FunctionClasses.Master
{
    public class BranchMaster
    {
        ...
        public string ISExists(string BranchName, Int64 BranchId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Branch", "branch_name", "AND branch_name = '" + BranchName + "' AND NOT branch_id =" + BranchId));
            }
        }
    }
}
