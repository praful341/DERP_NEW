...
namespace BLL.FunctionClasses.Master
{
    public class CompanyMaster
    {
        ...
        public string ISExists(string CompanyName, Int64 CompanyId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Company", "company_name", "AND company_name = '" + CompanyName + "' AND NOT company_id =" + CompanyId));
            }
        }
    }
}
