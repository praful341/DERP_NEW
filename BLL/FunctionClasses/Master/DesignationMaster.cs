...
namespace BLL.FunctionClasses.Master
{
    public class DesignationMaster
    {
        ...
        public string ISExists(string Designation, Int64 Desig_Id)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Designation", "designation", "AND designation = '" + Designation + "' AND NOT designation_id =" + Desig_Id));
            }
        }
    }
}
