...
namespace BLL.FunctionClasses.Transaction
{
    public class SaleInvoice
    {
        ...
        public int Delete_MemoRecive_Details(Sales_InvoiceProperty pClsProperty, Int32 flag, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                Request Request = new Request();
