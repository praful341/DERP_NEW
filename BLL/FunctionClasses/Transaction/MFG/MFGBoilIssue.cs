    ...
    public class MFGBoilIssue
    {
        ...
        public MFGBoilIssueProperty Save(MFGBoilIssueProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.AddParams("@prev_id", pClsProperty.Issue_id, DbType.Int32);
                ...
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_Boil_Issue_Save;
        ...
        public DataTable GetBoilIssuePending(int ProcessId,int SubProcessId)
        {
            ...
            Request.AddParams("@location_id", GlobalDec.gEmployeeProperty.location_id, DbType.Int32);
            Request.AddParams("@department_id", GlobalDec.gEmployeeProperty.department_id, DbType.Int32);
            Request.AddParams("@process_id", ProcessId, DbType.Int64);
            Request.AddParams("@sub_process_id", SubProcessId, DbType.Int64);

            Request.CommandText = BLL.TPV.SProc.MFG_IssRet_GetBoilIssuePendingStock;
            Request.CommandType = CommandType.StoredProcedure;
            Ope.GetDataTable(DBConnections.ConnectionString, DBConnections.ProviderName, DTabVal, Request);

            return DTabVal;
        }
        public DataTable GetBoilIssRecOS(int process_id, int sub_process_id, Int64 purchase_id, Int64 purchase_detail_id)
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_BoilIssRecOS_GetData;
            Request.CommandType = CommandType.StoredProcedure;
            Request.AddParams("@company_id", GlobalDec.gEmployeeProperty.company_id, DbType.Int32);
            Request.AddParams("@branch_id", GlobalDec.gEmployeeProperty.branch_id, DbType.Int32);
            Request.AddParams("@location_id", GlobalDec.gEmployeeProperty.location_id, DbType.Int32);
            ...
            Request.AddParams("@purchase_detail_id", purchase_detail_id, DbType.Int32);
        ...
        public MFGBoilIssueProperty Boil_Delete(MFGBoilIssueProperty pClsProperty)
        {
            try
            {
                ...
                stkRequest.AddParams("@union_id", pClsProperty.union_id, DbType.Int64);
                ...
                stkRequest.CommandText = BLL.TPV.SProc.MFG_TRN_BoilIssue_Delete;
