...
namespace BLL.FunctionClasses.Master
{
    public class StateMaster
    {
        ...
        public string ISExists(string StateName, Int64 StateId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_State", "state_name", "AND state_name = '" + StateName + "' AND NOT state_id =" + StateId));
            }
        }
    }
}
