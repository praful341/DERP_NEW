...
{
    public partial class FrmSubProcessRateMaster : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        SubProcessRateMaster objRate;

        #endregion

        #region Constructor
        public FrmSubProcessRateMaster()
        {
            InitializeComponent();
            ...
            objRate = new SubProcessRateMaster();
        }
        ...
        {
            bool blnReturn = true;
            SubProcessRate_MasterProperty RateMasterProperty = new SubProcessRate_MasterProperty();
            SubProcessRateMaster objRate = new SubProcessRateMaster();
            ...
            try
            {
                ...
                RateMasterProperty.process_id = Val.ToInt(lueProcess.EditValue);
                RateMasterProperty.rate = Val.ToDecimal(txtRate.Text);
                RateMasterProperty.sub_process_id = Val.ToInt(lueSubProcess.EditValue);
