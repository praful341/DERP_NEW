...
{
    public partial class FrmMFGAssortmentConfirm : DevExpress.XtraEditors.XtraForm
    {
        #region Declaration
        ...
        #region Constructor
        public FrmMFGAssortmentConfirm()
        {
            InitializeComponent();
        }
        ...
        public void ShowForm(FrmMFGAssortFinalLotting ObjForm)
        {
        ...
        public void ShowForm(FrmMFGAssortFinalOK ObjForm)
        {
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            if (FormName == "FrmMFGAssortFirst")
            {
                if (StrLotList.Length > 0)
                {
                    ...
                    this.Close();
                    FrmMFGAssortFirst.GetStockPendingData(DTab_Select);
                }
                else
                {
            ...
            else if (FormName == "FrmMFGAssortSecond")
            {
                if (StrLotList.Length > 0)
                {
                    DataTable DTab_Select = DTab.Select("lot_id in(" + StrLotList + ")").CopyToDataTable();
                    this.Close();
                    FrmMFGAssortSecond.GetStockPendingData(DTab_Select);
                }
                else
                {
                    Global.Message("Data Are Not Selected");
            ...
            else if (FormName == "FrmMFGAssortFinalLotting")
            {
                if (StrLotList.Length > 0)
                {
                    DataTable DTab_Select = DTab.Select("lot_id in(" + StrLotList + ")").CopyToDataTable();
                    this.Close();
                    FrmMFGAssortFinalLotting.GetStockPendingData(DTab_Select);
                }
                else
                {
                    Global.Message("Data Are Not Selected");
            ...
            else if (FormName == "FrmMFGAssortFinalOK")
            {
                if (StrLotList.Length > 0)
                {
                    DataTable DTab_Select = DTab.Select("lot_id in(" + StrLotList + ")").CopyToDataTable();
                    this.Close();
                    FrmMFGAssortFinalOK.GetStockPendingData(DTab_Select);
                }
                else
                {
                    Global.Message("Data Are Not Selected");
