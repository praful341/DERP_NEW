...
namespace DERP.MDI
{
    public partial class MDIMFG : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        private void MDIMain_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                BarChangeMode.Caption = "Mode : MANUFACTURING";
        ...
        private void BarChangeMode_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            FrmHomePage FrmStart = new FrmHomePage();
            FrmStart.ShowDialog();
        }
    }
}
