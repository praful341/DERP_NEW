...
{
    public class MFGRoughToMFGTransfer
    {
        InterfaceLayer Ope = new InterfaceLayer();
        Validation Val = new Validation();
        public MFGRoughToMFG_TransferProperty Save(MFGRoughToMFG_TransferProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughToMFG_Transfer_Save;
        ...
        public int Update(MFGRoughToMFG_TransferProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            int IntRes = 0;
            try
            {
        ...
        public DataTable GetSearchList(string fdate, string tdate)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughToMFG_SearchData;
        ...
        public DataTable GetData(Int64 Lotsrno)
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughToMFG_GetData;
        ...
        public int Delete(MFGRoughToMFG_TransferProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            int IntRes = 0;
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_RejectionToMFG_Transfer_Delete;
                Request.CommandType = CommandType.StoredProcedure;
