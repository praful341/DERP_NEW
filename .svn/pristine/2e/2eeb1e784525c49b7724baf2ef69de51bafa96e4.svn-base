...
namespace DREP.Master
{
    public partial class FrmUserMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void ShowForm()
        {
            ...
            if (GlobalDec.gEmployeeProperty.role_name.ToUpper() != "ADMIN" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "SURAT ADMIN" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "MUMBAI_ENTRY" &&
           GlobalDec.gEmployeeProperty.role_name.ToUpper() != "MASTER ADMIN" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "SURAT_ENTRY" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "SUPER ADMIN" &&
           GlobalDec.gEmployeeProperty.role_name.ToUpper() != "MIS ADMIN" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "KAMALA ADMIN" && GlobalDec.gEmployeeProperty.role_name.ToUpper() != "AMBIKA ADMIN")
            {
                Global.Message("User Not Permmission this Master... Please Contact to Administrator...");
                return;
            }


            //if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT 4P")
            //{
            //    if (GlobalDec.gEmployeeProperty.user_name.ToUpper() == "JIYA" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "SAROJ" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "RUSHIKESH" ||
            //            GlobalDec.gEmployeeProperty.user_name.ToUpper() == "NAVNITA" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "KAILASH4P")
            //    {
            //        Global.Message("User Not Permmission this Master... Please Contact to Administrator...");
            //        return;
            //    }
