...
namespace BLL.FunctionClasses.Master
{
    public class FinancialYearMaster
    {
        ...
        public string ISExists(string FinYear, Int64 FinYearId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Financial_Year", "financial_year", "AND financial_year = '" + FinYear + "' AND NOT fin_year_id =" + FinYearId));
            }
        }
        #endregion
    }
