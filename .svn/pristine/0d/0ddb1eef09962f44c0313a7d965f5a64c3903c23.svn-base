    ...
    public partial class FrmConfigRolePermissionMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmConfigRolePermissionMaster_Shown(object sender, System.EventArgs e)
        {
            try
            {
                ...
                Global.LOOKUPPermission(LookupCopyUser);
                Global.LOOKUPPermission(CmbReportRoleName);
                Global.LOOKUPPermission(CmbReportCopyUser);
            }
            catch (Exception ex)
            {
        ...
        private void btnCopy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Global.Confirm("Are You Sure You Want To Copy Data ? ", "DERP", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.No)
                {
                    return;
                }
                try
