...
{
    public partial class FrmStockIssuePendingReport : DevExpress.XtraEditors.XtraForm
    {
        #region "Data Member"
        ...
        public FrmStockIssuePendingReport()
        {
            InitializeComponent();
        }
        ...
        private void BtnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            ReportParams_Property.type = Val.ToString(RBtnType.SelectedIndex);
        ...
        private void backgroundWorker1_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            ...
            if (mIntPivot == 0)
            {
                ...
                if (RBtnType.SelectedIndex == 0 && FrmGReportViewer.Report_Type == "SUMMARY")
                {
                    FrmGReportViewer.ReportHeaderName = "Process Issue Summary Report";
                }
                else if (RBtnType.SelectedIndex == 0 && FrmGReportViewer.Report_Type == "DETAIL")
                {
                    FrmGReportViewer.ReportHeaderName = "Process Issue Detail Report";
                }
                else if (RBtnType.SelectedIndex == 1 && FrmGReportViewer.Report_Type == "SUMMARY")
                {
                    FrmGReportViewer.ReportHeaderName = "Process Receive Summary Report";
                }
                else if (RBtnType.SelectedIndex == 1 && FrmGReportViewer.Report_Type == "DETAIL")
                {
                    FrmGReportViewer.ReportHeaderName = "Process Receive Detail Report";
                }
                else
                {
        ...
        private void RbtReportType_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (Val.ToString(RbtReportType.EditValue) == "SUMMARY")
                {
        ...
        private void FillListControls()
        {
            ...
            DTabSieve.DefaultView.Sort = "rough_sieve_id";
            DTabSieve = DTabSieve.DefaultView.ToTable();

            ListRoughSieve.Properties.DataSource = DTabSieve;
            ListRoughSieve.Properties.DisplayMember = "sieve_name";
            ListRoughSieve.Properties.ValueMember = "rough_sieve_id";
            ...
            DataTable DTabProcess = ObjFillCombo.FillCmb(FillCombo.TABLE.Process_Master);
            DTabProcess.DefaultView.Sort = "process_id";
