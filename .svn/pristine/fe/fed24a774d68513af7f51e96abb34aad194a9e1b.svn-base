...
{
    public class RateDetailMaster
    {
        InterfaceLayer Ope = new InterfaceLayer();
        public int Save(RateDetail_MasterProperty pClsProperty)
        {
            Request Request = new Request();
            Request.AddParams("@user_id", GlobalDec.gEmployeeProperty.user_id, DbType.Int32);
            Request.AddParams("@ip_address", GlobalDec.gStrComputerIP, DbType.String);

            Request.CommandText = BLL.TPV.SProc.Rate_Detail_Master_Save;
        ...
        public DataTable GetData(int active = 0)
        {
            ...
            Request.CommandText = BLL.TPV.SProc.Rate_Detail_Master_GetData;
            Request.CommandType = CommandType.StoredProcedure;
            if (GlobalDec.gEmployeeProperty.Allow_Developer == 0)
            {
