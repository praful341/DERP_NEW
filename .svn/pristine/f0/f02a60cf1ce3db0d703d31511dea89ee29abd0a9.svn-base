...
namespace BLL.FunctionClasses.Master
{
    public class MenuHeaderMaster
    {
        ...
        public string ISExists(string MenuName, Int64 MenuId)
        {
            ...
            //else
            //{
            //    return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Menu_Header", "menu_name", "AND menu_name = '" + MenuName + "' AND NOT menu_id =" + MenuId));
            //}
        }
    }
}
