...
{
    public partial class FrmWeeklyPriceList : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        {
            if (Val.ToString(ObjReportDetailProperty.Remark.ToUpper()) == "WEEKLY_PRICE_ANALYSIS")
            {
        ...
        private void lueRateType_EditValueChanged(object sender, EventArgs e)
        {
            if (lueRateType.Text != "")
            {
                ...
                DataTable DTab = ObjRateType.GetDate_Weekly(RateTypeProperty);
