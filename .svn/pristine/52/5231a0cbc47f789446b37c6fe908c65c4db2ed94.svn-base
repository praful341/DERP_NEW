...
namespace BLL.FunctionClasses.Master
{
    public class RateMaster
    {
        ...
        public int Save(Rate_MasterProperty pClsProperty)
        {
            Request Request = new Request();

            Request.AddParams("@rate_id", pClsProperty.rate_id, DbType.Int32);
            Request.AddParams("@rate_date", pClsProperty.rate_date, DbType.String);
            ...
            Request.CommandText = BLL.TPV.SProc.MST_Rate_Save;
        ...
        public DataTable GetData(int active = 0)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MST_Rate_GetData;
            Request.CommandType = CommandType.StoredProcedure;
