...
{
    public partial class FrmMfgStatusMaster : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        MfgStatusMaster objStatus;
        #endregion

        #region Constructor
        public FrmMfgStatusMaster()
        {
            InitializeComponent();
        ...
        private void FrmMfgStatusMaster_Load(object sender, EventArgs e)
        {
            try
            {
                GetData();
        ...
        #region GridEvents
        private void dgvMfgStatusMaster_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            try
            {
                if (e.RowHandle >= 0)
                {
                    if (e.Clicks == 2)
                    {
                        ...
                        lblMode.Tag = Val.ToInt64(Drow["status_id"]);
                        txtStatus.Text = Val.ToString(Drow["status_name"]);
        ...
        {
            bool blnReturn = true;
            MfgStatus_MasterProperty StatusMasterProperty = new MfgStatus_MasterProperty();
            ...
            try
            {
                ...
                StatusMasterProperty.status_name = txtStatus.Text.ToUpper();
                StatusMasterProperty.sequence_no = Val.ToInt(txtSequenceNo.Text);
                StatusMasterProperty.remarks = txtRemark.Text.ToUpper();
                ...
                else
                {
                    ...
                    {
                        Global.Confirm("Status Details Data Successfully");
                    }
                    else
                    {
                        Global.Confirm("Status Details  Update Successfully");
                    }
                }
        ...
        private bool ValidateDetails()
        {
            ...
            try
            {
                ...
                {
                    lstError.Add(new ListError(12, "Status Name"));
                    if (!blnFocus)
                    {
                        blnFocus = true;
                        txtStatus.Focus();
                ...
                {
                    lstError.Add(new ListError(23, "Status Name"));
                    if (!blnFocus)
                    {
                        blnFocus = true;
                        txtStatus.Focus();
