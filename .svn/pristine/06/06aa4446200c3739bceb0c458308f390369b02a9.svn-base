...
{
    public class MFGRejectionJangedIssue
    {
        InterfaceLayer Ope = new InterfaceLayer();
        BLL.Validation Val = new BLL.Validation();

        public MFGRejectionJangedIssueProperty Save(MFGRejectionJangedIssueProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.AddParams("@currency_id", pClsProperty.currency_type_id, DbType.Int32);
                ...
                Request.AddParams("@broker_name", pClsProperty.rejection_broker_name, DbType.String);
                ...
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughRej_Master_Save;
                ...
                if (p_dtbSaleInvoiceNo != null)
                {
                    ...
                    {
                        pClsProperty.janged_id = Val.ToInt64(p_dtbSaleInvoiceNo.Rows[0][0]);
        ...
        public int Save_Detail(MFGRejectionJangedIssueProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                int IntRes = 0;
                ...
                RequestDetails.AddParams("@janged_det_id", pClsProperty.janged_detail_id, DbType.Int64);
                ...
                RequestDetails.CommandText = BLL.TPV.SProc.MFG_TRN_RoughRej_Detail_Save;
        ...
        public DataTable GetData(string p_dtpFromDate, string p_dtpToDate, string invoice_no, int partyId)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughRej_GetData;
        ...
        public DataTable GetDataDetails(Int64 p_Janged_ID)
        {
            DataTable DTab = new DataTable();
            try
            {
                Request Request = new Request();
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughRej_GetDetailData;
                Request.CommandType = CommandType.StoredProcedure;
                Request.AddParams("@janged_id", p_Janged_ID, DbType.Int64);
        ...
        public DataTable GetStockCarat(Int64 purityId)
        {
            DataTable DTab = new DataTable();
            try
            {
                Request Request = new Request();
                Request.CommandText = BLL.TPV.SProc.Get_Rej_Balance_Carat;
                Request.CommandType = CommandType.StoredProcedure;
        ...
        public int GetDeleteJanged_ID(MFGRejectionJangedIssueProperty pClsProperty)
        {
            DataTable DTab = new DataTable();
            int IntRes = 0;
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_RoughRej_Janged_Delete;
            Request.CommandType = CommandType.StoredProcedure;
        ...
        public string ISExists(string InvoiceNo, Int64 JangedId)
        {
            string Str = string.Empty;
            Str = Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, "MFG_TRN_Rej_Janged_Issue", "invoice_no", "AND invoice_no = '" + InvoiceNo + "' AND NOT janged_id =" + JangedId));
            return Str;
        }
    }
}
