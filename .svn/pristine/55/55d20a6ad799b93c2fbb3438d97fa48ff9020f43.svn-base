...
{
    public class MfgMachineItemMaster
    {
        InterfaceLayer Ope = new InterfaceLayer();
        Validation Val = new Validation();
        public int Save(MfgMachineItem_MasterProperty pClsProperty)
        {
            ...
            Request.CommandText = BLL.TPV.SProc.MFG_MST_MachineItem_Save;
        ...
        public DataTable GetData(int active = 0)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_MST_MachineItem_GetData;
            Request.CommandType = CommandType.StoredProcedure;
