...
namespace DERP
{
    public partial class FrmLogin : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmLogin_Shown(object sender, EventArgs e)
        {
            ...
            //string Name1 = GlobalDec.Decrypt("1m1aoLWd69HR1weotAkwaw==", true); 
            //string Name11 = GlobalDec.Decrypt("/7vDrPJrxqw=", true);
            //string Name12 = GlobalDec.Decrypt("OA96CdPNa4zrWScjha2Mfw==", true);
            //string Name13 = GlobalDec.Decrypt("n47TmcAYNn4lhGFA49zvYw==", true);

            ////string Name1 = GlobalDec.Decrypt("1DwL2KYsao4=", true);

            ////string Name2 = GlobalDec.Decrypt("1m1aoLWd69HR1weotAkwaw==", true);
            string Name4 = GlobalDec.Encrypt("DERP_SALES", true);
            //string Name14 = GlobalDec.Encrypt("DERP", true);
            //string Name2 = GlobalDec.Encrypt("sa", true);
            //string Name3 = GlobalDec.Encrypt("admin@123", true);
            //string Name14 = GlobalDec.Decrypt("FLUE/z/3B8A=", true);
            //string Name5 = GlobalDec.Decrypt("1DwL2KYsao4=", true);
            //string Name45 = GlobalDec.Decrypt("1m1aoLWd69HR1weotAkwaw==", true);
            ...
            //if (GlobalDec.gStrComputerIP == "192.168.1.7" || GlobalDec.gStrComputerIP == "192.168.1.4" || GlobalDec.gStrComputerIP == "192.168.1.116" || GlobalDec.gStrComputerIP == "192.168.1.112" || GlobalDec.gStrComputerIP == "192.168.1.13" || GlobalDec.gStrComputerIP == "192.168.29.176" || GlobalDec.gStrComputerIP == "194.168.1.34" || GlobalDec.gStrComputerIP == "194.168.1.37" || GlobalDec.gStrComputerIP == "192.168.29.175")
            //{
