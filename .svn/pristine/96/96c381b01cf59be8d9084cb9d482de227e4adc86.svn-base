...
namespace BLL.FunctionClasses.Master
{
    public class ColorMaster
    {
        ...
        public string ISExists(string ColorName, Int64 ColorId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_Color", "color_name", "AND color_name = '" + ColorName + "' AND NOT color_id =" + ColorId));
            }
        }
    }
}
