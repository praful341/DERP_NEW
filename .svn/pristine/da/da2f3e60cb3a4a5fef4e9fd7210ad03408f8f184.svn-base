...
namespace DERP.Report
{
    public partial class FrmEmployeeDetail : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmReportList_Load(object sender, EventArgs e)
        {
            ...
            DTPTillDate.Properties.Mask.Culture = new System.Globalization.CultureInfo("en-US");
            DTPTillDate.Properties.Mask.EditMask = "dd/MMM/yyyy";
            DTPTillDate.Properties.Mask.UseMaskAsDisplayFormat = true;
            DTPTillDate.Properties.CharacterCasing = CharacterCasing.Upper;
            DTPTillDate.Text = "";
        ...
        private void BtnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            ReportParams_Property.joining_from_date = Val.DBDate(DTPFromDate.Text);
            ReportParams_Property.joining_to_date = Val.DBDate(DTPToDate.Text);
            ReportParams_Property.leave_from_date = Val.DBDate(DTPLeaveFromDate.Text);
            ReportParams_Property.leave_to_date = Val.DBDate(DTPLeaveToDate.Text);
            ...
            ReportParams_Property.till_date = Val.DBDate(DTPTillDate.Text);
        ...
        private void RbtReportType_EditValueChanged(object sender, EventArgs e)
        {
            ...
            else if (ObjReportDetailProperty.Remark == "User_Detail_Report")
            {
                labelControl2.Visible = false;
                DTPTillDate.Visible = false;
                groupControl10.Visible = false;
            }
            else if (ObjReportDetailProperty.Remark == "Employee Detail Report")
            {
