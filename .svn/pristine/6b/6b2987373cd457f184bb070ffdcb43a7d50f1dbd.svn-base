    ...
    public class MFGAssortFinalOK
    {
        ...
        public MFGAssortFinal_OKProperty Save(MFGAssortFinal_OKProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                ...
                Request.CommandText = BLL.TPV.SProc.MFG_TRN_AssortFinal_OK_Save;
        ...
        public MFGAssortFinal_OKProperty GhatSave(MFGAssortFinal_OKProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                Request Request = new Request();
        ...
        public DataTable AssortFinalGetData(string Assort, string Sieve, Int32 kapan_id, Int32 rough_cut_id, Int32 process_id, Int32 sub_process_id, string temp_sieve_name, Int64 lot_srno, Int64 Location_ID, string rate_date)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.MFG_TRN_Assort_FinalOK_GetData;
        ...
        public DataSet Print_Assort_Final(int numkapan_id, int numcut_id, int numprocess_id, int numsubProcess_id, Int64 lot_srno, Int64 Location_ID, string Date, string Rate_Date)
        {
            ...
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.RPT_MFG_TRN_Assortment_Final_OK;
        ...
        public DataSet Print_Assort_Final_Mumbai(int numkapan_id, int numcut_id, int numprocess_id, int numsubProcess_id, Int64 lot_srno, Int64 Location_ID, string Date)
        {
            DataSet DTab = new DataSet();
            Request Request = new Request();
        ...
        public int GetUpdateLot_ID_Flag(MFGAssortFinal_OKProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            DataTable DTab = new DataTable();
            int IntRes = 0;
            Request Request = new Request();
        ...
        public int GetDeleteLot_ID(MFGAssortFinal_OKProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            DataTable DTab = new DataTable();
            int IntRes = 0;
            Request Request = new Request();
        ...
        public int GetDeleteFinalLot_ID(MFGAssortFinal_OKProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            DataTable DTab = new DataTable();
            int IntRes = 0;
            Request Request = new Request();
