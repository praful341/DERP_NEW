...
namespace BLL.FunctionClasses.Master
{
    public class IDProofMaster
    {
        ...
        public string ISExists(string IDProofName, Int64 IDProofId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_ID_Proof", "idproof_name", "AND idproof_name = '" + IDProofName + "' AND NOT idproof_id =" + IDProofId));
            }
        }
    }
}
