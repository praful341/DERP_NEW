...
{
    public partial class FrmHRReportViewerBand : DevExpress.XtraEditors.XtraForm
    {
        #region Delcaration
        ...
        private void FrmGReportViewer_Load(object sender, EventArgs e)
        {
            ...
            if (flag == 0)
            {
                mIntReportCode = Val.ToInt(20057);
            }
            else
            {
                mIntReportCode = Val.ToInt(this.Tag);
            ...
            DataTable DTabFactory = objHRFactory.GetData();
            DTabFactory.DefaultView.Sort = "factory_name";
            DTabFactory = DTabFactory.DefaultView.ToTable();

            ListFactory.Properties.DataSource = DTabFactory;
            ListFactory.Properties.DisplayMember = "factory_name";
            ListFactory.Properties.ValueMember = "factory_id";

            DataTable DTabFactoryDept = objHRFactoryDept.Fact_Dept_GetData(1);
            DTabFactoryDept.DefaultView.Sort = "fact_dept_name";
            DTabFactoryDept = DTabFactoryDept.DefaultView.ToTable();

            ListFactDepartment.Properties.DataSource = DTabFactoryDept;
            ListFactDepartment.Properties.DisplayMember = "fact_dept_name";
            ListFactDepartment.Properties.ValueMember = "fact_department_id";
        ...
        public void FillGrid()
        {
            ...
            try
            {
                ...
                GridView1.Appearance.Row.Font = new Font(ObjReportDetailProperty.Font_Name, float.Parse(Val.ToString(ObjReportDetailProperty.Font_Size)), FontStyle.Bold);
                GridView1.AppearancePrint.Row.Font = new Font(ObjReportDetailProperty.Font_Name, float.Parse(Val.ToString(ObjReportDetailProperty.Font_Size)), FontStyle.Bold);
        ...
        private void GridView1_CustomSummaryCalculate(object sender, CustomSummaryEventArgs e)
        {
            ...
            if (Val.ToString(ObjReportDetailProperty.Remark).ToUpper() == "DAILY_AVG_REPORT_EMPWISE")
            {
                ...
                {
                    DouTaliya = DouTaliya + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "TALIYA"));
                    DouTaliyaCnt = DouTaliyaCnt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "TALIYA_CNT"));
                    DouPel = DouPel + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "PEL"));
                    DouPelCnt = DouPelCnt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "PEL_CNT"));
                    DouMathala = DouMathala + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "MATHALA"));
                    DouMathalaCnt = DouMathalaCnt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "MATHALA_CNT"));
                    DouTable = DouTable + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "TABLE"));
                    DouTableCnt = DouTableCnt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "TABLE_CNT"));
                }
        ...
        private void BtnReset_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < ListFactory.Properties.Items.Count; i++)
                ListFactory.Properties.Items[i].CheckState = CheckState.Unchecked;
            for (int i = 0; i < ListFactDepartment.Properties.Items.Count; i++)
                ListFactDepartment.Properties.Items[i].CheckState = CheckState.Unchecked;
        ...
        {
            DTab = ObjReportParams.GetHRReport(ReportParams_Property, ObjReportDetailProperty.Procedure_Name);
        }
        ...
        {
            FrmHRReportViewerBand FrmGReportViewer = new Report.FrmHRReportViewerBand();
        ...
        {
            if (Val.ToString(ListFactory.Text) != "" && Val.ToString(ListFactDepartment.Text) != "")
            {
                ...
                HREmpMasterProperty.fact_department_name = Val.Trim(ListFactDepartment.Properties.GetCheckedItems());
                HREmpMasterProperty.factory_id = Val.ToInt64(ListFactory.EditValue);

                DataTable Dtab_Fact_Dept = objHREmp.Fact_Dept_Wise_ManagerGetDataReport(HREmpMasterProperty);
        ...
        private void txtYear_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                HREmployeeMaster objHREmp = new HREmployeeMaster();
                DataTable DTab_Distint_BookNo = objHREmp.Dtab_Distint_BookNo(Val.ToInt(txtYear.Text), Val.ToInt(txtMonth.Text));

                ListBookNo.Properties.DataSource = DTab_Distint_BookNo;
                ListBookNo.Properties.DisplayMember = "book_no";
                ListBookNo.Properties.ValueMember = "book_no";
            }
        }
        ...
        private void GridView1_RowCellStyle(object sender, RowCellStyleEventArgs e)
        {
            try
            {
                if (e.RowHandle >= 0)
                {
                    if (e.Column.Name == "colTALIYA_AVG")
                    {
                        if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "TALIYA_AVG")) > 75)
                        {
                            e.Appearance.BackColor = Color.LightGreen;
                        }
                        else if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "TALIYA_AVG")) < 75 && Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "TALIYA_AVG")) > 0)
                        {
                            e.Appearance.BackColor = Color.LightPink;
                        }
                    }

                    if (e.Column.Name == "colPEL_AVG")
                    {
                        if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "PEL_AVG")) > 135)
                        {
                            e.Appearance.BackColor = Color.LightGreen;
                        }
                        else if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "PEL_AVG")) < 135 && Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "PEL_AVG")) > 0)
                        {
                            e.Appearance.BackColor = Color.LightPink;
                    ...
                    if (e.Column.Name == "colMATHALA_AVG")
                    {
                        if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "MATHALA_AVG")) > 110)
                        {
                            e.Appearance.BackColor = Color.LightGreen;
                        }
                        else if (Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "MATHALA_AVG")) < 110 && Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "MATHALA_AVG")) > 0)
                        {
                            e.Appearance.BackColor = Color.LightPink;
                        }
                    }
                    ...
                    //    if(Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "TALIYA_AVG")) > 75
                    //        &&
                    //        Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "PEL_AVG")) > 135
                    //        &&
                    //        Val.ToInt(GridView1.GetRowCellValue(e.RowHandle, "MATHALA_AVG")) > 110
                    //        )
                    //    {
                    //        e.Appearance.Image = imageCollection1.Images[0];
                    //    }
