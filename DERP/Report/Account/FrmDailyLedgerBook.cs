...
{
    public partial class FrmDailyLedgerBook : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void BtnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            ReportParams_Property.ledger_name = Val.ToString(ListLedger.Text);
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            try
            {
                if (Val.ToString(ObjReportDetailProperty.Remark) == "Daily Ledger Book")
                {
                    ...
                    if (ListLedger.EditValue.ToString() != string.Empty)
                    {
                    ...
                    else
                    {
                        ...
                        foreach (DataRow Drw in DTab.Rows)
                        {
                            ...
                            {
                                numBalance = 0;
                                numBalance = Val.ToDecimal(Drw["Opening_Amt"]) + Val.ToDecimal(Drw["Credit_Amt"]) - Val.ToDecimal(Drw["Debit_Amt"]);
                                Drw["Balance"] = numBalance;
                            }
                ...
                if (Val.ToString(ObjReportDetailProperty.Remark) == "Payment_Pending_Remark")
                {
                    foreach (DataRow Drw in DTab.Rows)
                    {
                        numBalance = numBalance + Val.ToDecimal(Drw["opening_amount"]) + Val.ToDecimal(Drw["sale_amount"]) - Val.ToDecimal(Drw["receive_amount"]) - Val.ToDecimal(Drw["salereturn_amount"]) - Val.ToDecimal(Drw["purchase_amount"]);
        ...
        private void RbtReportType_EditValueChanged(object sender, EventArgs e)
        {
            ...
            string Header_Name = ObjReportDetailProperty.Report_Header_Name;
            this.Text = Header_Name;
        }
