    ...
    public partial class FrmDepartmentMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmDepartmentMaster_Load(object sender, System.EventArgs e)
        {
            try
            {
                ...
                Global.LOOKUPDeptType(lueDepartmentType);
                //m_department_type = new DataTable();
                //m_department_type.Columns.Add("manager_type");
                //m_department_type.Rows.Add("Office");
                //m_department_type.Rows.Add("MFG");
                //m_department_type.Rows.Add("Main Manager");

                //lueDepartmentType.Properties.DataSource = m_department_type;
                //lueDepartmentType.Properties.ValueMember = "manager_type";
                //lueDepartmentType.Properties.DisplayMember = "manager_type";
            }
            catch (Exception ex)
            {
