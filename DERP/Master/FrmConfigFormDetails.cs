...
{
    public partial class FrmConfigFormDetails : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        #region Events       
        private void FrmConfigFormDetails_Load(object sender, EventArgs e)
        {
            try
            {
                Global.LOOKUPForm(lueFormName);
                Global.LOOKUPEmployee(lueRole);
            }
            catch (Exception ex)
            {
