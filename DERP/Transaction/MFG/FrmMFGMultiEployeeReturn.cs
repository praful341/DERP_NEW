    ...
    public partial class FrmMFGMultiEployeeReturn : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void lueProcess_EditValueChanged_2(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lueProcess.EditValue != System.DBNull.Value)
                {
                    ...
                    if ((GlobalDec.gEmployeeProperty.role_name == "SURAT 4P" && GlobalDec.gEmployeeProperty.user_name == "KETAN") || (GlobalDec.gEmployeeProperty.role_name == "SURAT KATARGAM") || (GlobalDec.gEmployeeProperty.role_name == "SURAT 4P OK" && GlobalDec.gEmployeeProperty.user_name == "4POK") || (GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN" && GlobalDec.gEmployeeProperty.user_name == "RAVIR") || (GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN" && GlobalDec.gEmployeeProperty.user_name == "JIYA"))
                    {
        ...
        private void lueSubProcess_EditValueChanged(object sender, EventArgs e)
        {
            if (lueProcess.EditValue != System.DBNull.Value && lueSubProcess.EditValue != System.DBNull.Value && Val.ToInt64(txtLotID.Text) != 0)
            {
                ...
                if ((GlobalDec.gEmployeeProperty.user_name == "JIYA" || GlobalDec.gEmployeeProperty.user_name == "SAROJ" || GlobalDec.gEmployeeProperty.user_name == "RUSHIKESH" || GlobalDec.gEmployeeProperty.user_name == "NAVDIP")
                && GlobalDec.gEmployeeProperty.department_name == "4P" && lueProcess.Text == "4P" && lueSubProcess.Text == "4P OK")
                {
                    lblBreakragePcs.Visible = true;
                    lblBreakrageCarat.Visible = true;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                if (AddInGrid())
                {
                    ...
                    else if (GlobalDec.gEmployeeProperty.role_name == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN ENTRY" || GlobalDec.gEmployeeProperty.role_name == "SURAT 4P ENTRY" || GlobalDec.gEmployeeProperty.role_name == "SURAT KATARGAM")
                    {
                        lueMachine.Focus();
                    }
