...
namespace DERP.Transaction.MFG
{
    public partial class FrmMFGStockConfirm : DevExpress.XtraEditors.XtraForm
    {
        ...
        public FrmMFGBoilingNo FrmMFGBoilingNo = new FrmMFGBoilingNo();
        string FormName = "";
        ...
        public void ShowForm(FrmMFGBoilingNo ObjForm)
        {
            FrmMFGBoilingNo = new FrmMFGBoilingNo();
            FrmMFGBoilingNo = ObjForm;
            FormName = "FrmMFGBoilingNo";
        ...
        private void BtnOk_Click(object sender, EventArgs e)
        {
            ...
            else if (FormName == "FrmMFGBoilingNo")
            {
                if (StrLotList.Length > 0)
                {
                    DataTable DTab_Select = DTab.Select("lot_id in(" + StrLotList + ")").CopyToDataTable();
                    this.Close();
                    FrmMFGBoilingNo.GetStockData(DTab_Select);
                }
                else
                {
                    Global.Message("Data Are Not Selected");
