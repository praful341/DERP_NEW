...
namespace DREP.Transaction
{
    public partial class FrmMFGPurchase : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if ((Val.ToString(txtPartyInvoiceNo.Text) != "" || Val.ToString(txtPartyInvoiceNo.Text) != null) && Val.ToString(lblMode.Text) != "Edit Mode")
            {
                string InvoiceNo = "";
                InvoiceNo = objMFGPurchase.CheckPurchaseInvoiceNo(Val.ToString(txtPartyInvoiceNo.Text));
                if (InvoiceNo != "")
                {
                    Global.Message("Invoice No Already Entered Please Try Another.");
                    btnSave.Enabled = true;
        ...
        private void backgroundWorker_MFGPurchase_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    objMFGPurchaseProperty.type = Val.ToString(lueType.EditValue);
        ...
        private void txtPartyInvoiceNo_EditValueChanged(object sender, EventArgs e)
        {
            
        }

        private void txtPartyInvoiceNo_Validated(object sender, EventArgs e)
        {
            try
            {
                if ((Val.ToString(txtPartyInvoiceNo.Text) != "" || Val.ToString(txtPartyInvoiceNo.Text) != null) && Val.ToString(lblMode.Text) != "Edit Mode")
        ...
        private void txtInvoiceNo_Validated(object sender, EventArgs e)
        {
            try
            {
                if (Val.ToString(txtInvoiceNo.Text) != "" || Val.ToString(txtInvoiceNo.Text) != null)
                {
                    string InvoiceNo = "";
                    InvoiceNo = objMFGPurchase.CheckPurchaseInvoiceNo(Val.ToString(txtInvoiceNo.Text));
                    if (InvoiceNo != "")
                    {
                        Global.Message("Invoice No Already Entered Please Try Another.");
                        txtInvoiceNo.Focus();
