...
{
    public partial class FrmCostPriceImport : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        CostPriceImport ObjCostPriceImport;
        ...
        public FrmCostPriceImport()
        {
            ...
            ObjCostPriceImport = new CostPriceImport();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    DTab_Data = (DataTable)grdCostPriceImport.DataSource;
                    if (DTab_Data != null)
                    {
                    ...
                    backgroundWorker_CostPriceImport.RunWorkerAsync();
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DTabFile.Rows.Clear();
                grdCostPriceImport.DataSource = null;
            }
            catch (Exception ex)
            {
                Global.Message(ex.ToString());
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                grdCostPriceImport.DataSource = DTabFile;
                this.Cursor = Cursors.Default;
            }
            catch (Exception ex)
            {
        ...
        private void backgroundWorker_PriceImport_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                CostPrice_ImportProperty ObjCostPriceImportProperty = new CostPrice_ImportProperty();
                try
                {
                    IntRes = 0;
                    ...
                    ObjCostPriceImportProperty.cost_rate_date = Val.DBDate(dtpDate.Text);
                    ObjCostPriceImportProperty.rate_type_id = Val.ToInt32(lueRateType.EditValue);
                    ObjCostPriceImportProperty.currency_id = Val.ToInt32(lueCurrency.EditValue);

                    int IntResMst = ObjCostPriceImport.MasterSave(ObjCostPriceImportProperty, DLL.GlobalDec.EnumTran.Continue, Conn);

                    int Rate_id = ObjCostPriceImportProperty.cost_rate_id;
                    ...
                    if (IntResMst > 0)
                    {
                        foreach (DataRow DRow in DTab_Data.Rows)
                        {
                            ...
                            ObjCostPriceImportProperty = new CostPrice_ImportProperty();
                            ObjCostPriceImportProperty.cost_rate_id = Val.ToInt(Rate_id);
                            ObjCostPriceImportProperty.assort_id = Val.ToInt(DAssort.Rows[0]["assort_id"]);
                            ObjCostPriceImportProperty.sieve_id = Val.ToInt(DSieve.Rows[0]["sieve_id"]);
                            ObjCostPriceImportProperty.rate = Val.ToDecimal(DTab_Data.Rows[i]["rate"]);

                            i++;
                            ObjCostPriceImportProperty.sequence_no = i;
                            IntRes = ObjCostPriceImport.DetailSave(ObjCostPriceImportProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                ...
                {
                    ObjCostPriceImportProperty = null;
                }
            }
            catch (Exception ex)
            {
        ...
        private void backgroundWorker_PriceImport_RunWorkerCompleted(object sender, System.ComponentModel.RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                if (IntRes > 0)
                {
                    Global.Confirm("Cost Price Import Data Save Successfully");
                    i = 0;
                ...
                {
                    Global.Confirm("Error In Cost Price Import");
                    this.Cursor = Cursors.Default;
                    dtpDate.Focus();
                }
            }
