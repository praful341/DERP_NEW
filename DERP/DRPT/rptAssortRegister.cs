...
namespace DERP.DRPT
{
    public partial class rptAssortRegister : DevExpress.XtraReports.UI.XtraReport
    {
        #region "Data Members"
        ...
        {
            m_numSumInCarats += Val.ToDecimal(GetCurrentColumnValue("salecarat"));
            m_numSumInAmount += Val.ToDecimal(GetCurrentColumnValue("saleamount"));
